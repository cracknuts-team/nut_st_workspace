...
extern UART_HandleTypeDef huart1;
extern UART_HandleTypeDef huart2;
extern uint8_t rx1_buffer[BUF_SIZE];
extern uint8_t rx2_buffer[BUF_SIZE];
...
void HAL_UARTEx_RxEventCallback(UART_HandleTypeDef *huart, uint16_t Size)
{
    ...
    {
        rx1_cnt = BUF_SIZE - __HAL_DMA_GET_COUNTER(&hdma_usart1_rx);
   ...
   //     memset(rx_buffer, 0, cnt);
    ...
    {
        rx2_cnt = BUF_SIZE - __HAL_DMA_GET_COUNTER(&hdma_usart2_rx);
   //     HAL_UART_Transmit(&huart1, rx_buffer, cnt, 0xffff);
   //     memset(rx_buffer, 0, cnt);
